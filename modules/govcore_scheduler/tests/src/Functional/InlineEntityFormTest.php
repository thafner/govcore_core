...
class InlineEntityFormTest extends BrowserTestBase {
  ...
  protected function setUp() {
    ...
    govcore_workflow_entity_get_form_display('user', 'user', 'default')
    ...
    govcore_workflow_entity_get_form_display('node', 'alpha', 'default')
      ->setComponent('field_inline_entity', [
        'type' => 'inline_entity_form_simple',
      ])
      ->save();
 ...
 */
function govcore_workflow_entity_get_form_display($entity_type, $bundle, $form_mode = 'default') {
