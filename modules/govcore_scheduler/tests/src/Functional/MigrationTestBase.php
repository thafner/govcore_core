...
/**
 * Base class for testing migration of old GovCore Scheduler data.
 */
abstract class MigrationTestBase extends UpdatePathTestBase {
  ...
  /**
   * Runs a basic test of migrating old GovCore Scheduler data.
   *
  ...
  public function test() {
    ...
    $migrations = $this->container->get('state')->get('govcore_scheduler.migrations');
