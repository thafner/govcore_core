...
/**
 * The settings form for controlling GovCore Scheduler's behavior.
 */
class SettingsForm extends ConfigFormBase {
  ...
  protected function getEditableConfigNames() {
    return ['govcore_scheduler.settings'];
  }
  ...
  public function getFormId() {
    return 'govcore_scheduler_settings_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $form['time_step'] = [
      ...
      '#required' => TRUE,
      '#default_value' => $this->config('govcore_scheduler.settings')->get('time_step'),
    ];
