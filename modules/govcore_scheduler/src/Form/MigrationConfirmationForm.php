...
namespace Drupal\govcore_scheduler\Form;
...
use Drupal\Core\Url;
use Drupal\govcore_scheduler\Migrator;
...
final class MigrationConfirmationForm extends ConfirmFormBase {
   ...
   *
   * @var \Drupal\govcore_scheduler\Migrator
   */
  protected $migrator;
   ...
   *
   * @param \Drupal\govcore_scheduler\Migrator $migrator
   *   The migrator service.
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      $container->get('govcore_scheduler.migrator'),
  ...
  public function getFormId() {
    return 'govcore_scheduler_migration_confirm_form';
  }
  ...
  public static function migrate($entity_type_id, \stdClass $item) {
    \Drupal::service('govcore_scheduler.migrator')
