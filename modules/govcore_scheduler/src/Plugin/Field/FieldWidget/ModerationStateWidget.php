...
namespace Drupal\govcore_scheduler\Plugin\Field\FieldWidget;
...
use Drupal\govcore_scheduler\TransitionManager;
use Drupal\govcore_scheduler\TransitionSet;
...
class ModerationStateWidget extends BaseModerationStateWidget {
   ...
   *
   * @var \Drupal\govcore_scheduler\TransitionManager
   */
   ...
   * @param \Drupal\govcore_scheduler\TransitionManager $transition_manager
   *   The transition manager.
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $container->get('govcore_scheduler.transition_manager'),
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    $element['scheduled_transitions'] = [
      ...
      '#attributes' => [
        ...
        'step' => $this->configFactory->get('govcore_scheduler.settings')->get('time_step'),
      ],
      '#attached' => [
        'library' => ['govcore_scheduler/widget'],
      ],
      'data' => [
        '#type' => 'hidden',
        '#element_validate' => [
