...
final class Migrator {
  ...
  public function getMigrations() {
    return $this->state->get('govcore_scheduler.migrations', []);
  }
  ...
  public function setMigrations(array $migrations) {
    return $this->state->set('govcore_scheduler.migrations', $migrations);
  }
  ...
  public function migrate($entity_type_id, $item) {
    ...
    // little too strong. See govcore_scheduler_entity_presave().
