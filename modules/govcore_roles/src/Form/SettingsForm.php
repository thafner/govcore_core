...
namespace Drupal\govcore_roles\Form;
...
/**
 * The settings form for controlling GovCore Roles' behavior.
 */
class SettingsForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'govcore_roles_settings_form';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $config = $this->config('govcore_roles.settings');
