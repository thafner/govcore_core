...
namespace Drupal\Tests\govcore_roles\Kernel;
...
class ContentRoleManagerTest extends KernelTestBase {
  ...
  protected function setUp() {
    parent::setUp();
    $this->installConfig('govcore_roles');
   ...
   *
   * @covers \Drupal\govcore_roles\ContentRoleManager::grantPermissions
   */
  public function test() {
    ...
    $this->container->get('govcore.content_roles')
