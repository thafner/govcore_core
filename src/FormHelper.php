...
final class FormHelper {
  ...
  public function __construct(ElementInfoManagerInterface $element_info) {
    @trigger_error(__CLASS__ . ' is deprecated in govcore_core:8.x-5.6 and will be removed in govcore_core:8.x-6.0. Use \Drupal\Core\Render\ElementInfoManagerInterface::getInfo() instead. See https://www.drupal.org/node/3156221', E_USER_DEPRECATED);
