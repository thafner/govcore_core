...
class ConfigHelper extends InstallStorage {
  ...
  /**
   * Checks if a config entity is bundled with GovCore.
   *
   * @param \Drupal\Core\Config\Entity\ConfigEntityInterface $entity
   *   The config entity.
   *
   * @return bool
   *   Whether the config entity is marked as being bundled with GovCore.
   */
  public static function isBundled(ConfigEntityInterface $entity) {
    return (bool) $entity->getThirdPartySetting('govcore', 'bundled', FALSE);
  }
